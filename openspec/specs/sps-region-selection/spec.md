...
Define how the controller uses fresh Spot Placement Score and regional-readiness
evidence to recommend or establish the initial parent Region for a capacity target
without weakening single-Region ownership, operator-approved migration, or
within-Region Local Zone fallback safety.
